...
//        lunarCalendar.CalculateLunarCalendar(2020,04,04);

String file = "data:image/jpeg;base64,/9j/4AAQSkZJRgABAgEAYABgAAD/7ABrRHVja3kAAQAEAAAAZAADAFYAAAApACgAYwApACAATgBhAHQAcABoAG8AdABvAHMALwBEAGkAZwBpAHQAYQBsACAAVgBpAHMAaQBvAG4ALwBHAGUAdAB0AHkAIABJAG0AYQBnAGUAcwAA";
        String [] array = file.split(";");
        String suffix = array[0].split("/")[1];
        String imgStr = array[1].split(",")[1];
        String fullFileName = UUID.randomUUID().toString().replace("-", "")+ '.' + suffix;
